...
type CardSet struct {
	...
	FrameVersion            string                 `protobuf:"bytes,53,opt,name=frameVersion,proto3" json:"frameVersion,omitempty"`
	HasContentWarning       bool                   `protobuf:"varint,54,opt,name=hasContentWarning,proto3" json:"hasContentWarning,omitempty"`
	HasFoil                 bool                   `protobuf:"varint,55,opt,name=hasFoil,proto3" json:"hasFoil,omitempty"`
	HasNonFoil              bool                   `protobuf:"varint,56,opt,name=hasNonFoil,proto3" json:"hasNonFoil,omitempty"`
	IsAlternative           bool                   `protobuf:"varint,57,opt,name=isAlternative,proto3" json:"isAlternative,omitempty"`
	IsFullArt               bool                   `protobuf:"varint,58,opt,name=isFullArt,proto3" json:"isFullArt,omitempty"`
	IsOnlineOnly            bool                   `protobuf:"varint,59,opt,name=isOnlineOnly,proto3" json:"isOnlineOnly,omitempty"`
	IsOversized             bool                   `protobuf:"varint,60,opt,name=isOversized,proto3" json:"isOversized,omitempty"`
	IsPromo                 bool                   `protobuf:"varint,61,opt,name=isPromo,proto3" json:"isPromo,omitempty"`
	IsRebalanced            bool                   `protobuf:"varint,62,opt,name=isRebalanced,proto3" json:"isRebalanced,omitempty"`
	IsReprint               bool                   `protobuf:"varint,63,opt,name=isReprint,proto3" json:"isReprint,omitempty"`
	IsStarter               bool                   `protobuf:"varint,64,opt,name=isStarter,proto3" json:"isStarter,omitempty"`
	IsStorySpotlight        bool                   `protobuf:"varint,65,opt,name=isStorySpotlight,proto3" json:"isStorySpotlight,omitempty"`
	IsTextless              bool                   `protobuf:"varint,66,opt,name=isTextless,proto3" json:"isTextless,omitempty"`
	IsTimeshifted           bool                   `protobuf:"varint,67,opt,name=isTimeshifted,proto3" json:"isTimeshifted,omitempty"`
	Language                string                 `protobuf:"bytes,68,opt,name=language,proto3" json:"language,omitempty"`
	Number                  string                 `protobuf:"bytes,69,opt,name=number,proto3" json:"number,omitempty"`
	OriginalPrintings       []string               `protobuf:"bytes,70,rep,name=originalPrintings,proto3" json:"originalPrintings,omitempty"`
	OriginalReleaseDate     string                 `protobuf:"bytes,71,opt,name=originalReleaseDate,proto3" json:"originalReleaseDate,omitempty"`
	OriginalText            string                 `protobuf:"bytes,72,opt,name=originalText,proto3" json:"originalText,omitempty"`
	OriginalType            string                 `protobuf:"bytes,73,opt,name=originalType,proto3" json:"originalType,omitempty"`
	OtherFaceIds            []string               `protobuf:"bytes,74,rep,name=otherFaceIds,proto3" json:"otherFaceIds,omitempty"`
	PromoTypes              []string               `protobuf:"bytes,75,rep,name=promoTypes,proto3" json:"promoTypes,omitempty"`
	Rarity                  string                 `protobuf:"bytes,76,opt,name=rarity,proto3" json:"rarity,omitempty"`
	RebalancedPrintings     []string               `protobuf:"bytes,77,rep,name=rebalancedPrintings,proto3" json:"rebalancedPrintings,omitempty"`
	SecurityStamp           string                 `protobuf:"bytes,78,opt,name=securityStamp,proto3" json:"securityStamp,omitempty"`
	SetCode                 string                 `protobuf:"bytes,79,opt,name=setCode,proto3" json:"setCode,omitempty"`
	Signature               string                 `protobuf:"bytes,80,opt,name=signature,proto3" json:"signature,omitempty"`
	SourceProducts          *meta.SourceProducts   `protobuf:"bytes,81,opt,name=sourceProducts,proto3" json:"sourceProducts,omitempty"`
	Uuid                    string                 `protobuf:"bytes,82,opt,name=uuid,proto3" json:"uuid,omitempty"`
	Variations              []string               `protobuf:"bytes,83,rep,name=variations,proto3" json:"variations,omitempty"`
	Watermark               []string               `protobuf:"bytes,84,rep,name=watermark,proto3" json:"watermark,omitempty"`
	MtgjsonApiMeta          *meta.MTGJSONAPIMeta   `protobuf:"bytes,85,opt,name=mtgjsonApiMeta,proto3" json:"mtgjsonApiMeta,omitempty"`
}
