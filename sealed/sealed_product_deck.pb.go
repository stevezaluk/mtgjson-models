...
const file_sealed_sealed_product_deck_proto_rawDesc = "" +
	"\n" +
	" sealed/sealed_product_deck.proto\x12\x06sealed\"9\n" +
	"\x11SealedProductDeck\x12\x12\n" +
...
var (
	...
	file_sealed_sealed_product_deck_proto_rawDescData []byte
)

func file_sealed_sealed_product_deck_proto_rawDescGZIP() []byte {
	file_sealed_sealed_product_deck_proto_rawDescOnce.Do(func() {
		file_sealed_sealed_product_deck_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sealed_sealed_product_deck_proto_rawDesc), len(file_sealed_sealed_product_deck_proto_rawDesc)))
	})
...
func file_sealed_sealed_product_deck_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sealed_sealed_product_deck_proto_rawDesc), len(file_sealed_sealed_product_deck_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
